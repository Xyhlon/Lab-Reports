...
\begin{table}[H]
	...
	\begin{center}
		\include{./tables/messreihe_messwertversuch1}
	\end{center}
\end{table}
...
\begin{table}[H]
	...
	\begin{center}
		\include{./tables/messreihe_messwertversuch2}
	\end{center}
\end{table}
...
\begin{table}[H]
	...
	\begin{center}
		\include{./tables/messreihe_messwertversuch3_1}
	\end{center}
\end{table}
...
\begin{table}[H]
	...
	\begin{center}
		\include{./tables/messreihe_messwertversuch3_2}
	\end{center}
\end{table}
...
\begin{table}[H]
	...
	\begin{center}
		\include{./tables/messreihe_wertversuch1}
	\end{center}
\end{table}
...
\begin{table}[H]
	...
	\begin{center}
		\include{./tables/messreihe_wertversuch2}
	\end{center}
\end{table}
...
\begin{table}[H]
	...
	\begin{center}
		\include{./tables/messreihe_wertversuch3}
	\end{center}
\end{table}
...
\begin{table}[H]
	...
	\begin{center}
		\include{./tables/messreihe_wertversuch3_extra}
	\end{center}
\end{table}
...
\begin{table}[H]
	...
	\begin{center}
		\include{./tables/messreihe_wertversuch3_extra_cont}
	\end{center}
\end{table}
