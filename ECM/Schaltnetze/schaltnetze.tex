...
% Als Betriebsspannung $U_B$ wurde eine Spannung von \SI{5}{\volt} und als
% Eingangsspannung $V_e$ eine Puls-Spannungsquelle mit einer Spannung von
% \SI{5}{\volt} (Spezifikationen nach Schaltplan) gewählt.
